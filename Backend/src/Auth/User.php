...
class User
{
    ...
    private string $role; // 'admin' | 'postal_iut' | 'acteur'
    ...
    public function getUidCas(): string
    {
        return $this->uid_cas;
    }
    ...
    public function isPostalIut(): bool
    {
        return $this->role === 'postal_iut';
    }

    public function isActeur(): bool
    {
        return $this->role === 'acteur';
    }
}
